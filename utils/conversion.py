...
def usdz_to_xyz(usdz_file_path, output_xyz_file_path, step_size=0.25, error_range=0.05):
    """Convert a USDZ file to an XYZ file with points sampled along the edges of the Mesh prims."""
