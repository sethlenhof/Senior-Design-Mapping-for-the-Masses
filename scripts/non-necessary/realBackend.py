...
Original file is located at
    https://colab.research.google.com/drive/1nHTboNOsLjqsUhZa3DMFfmpqtHXNCVfj
"""
...
#only additions to old back end
blueprint = blueprint[[blueprint.columns[0], blueprint.columns[2], blueprint.columns[1]]]
